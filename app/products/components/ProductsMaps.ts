...
let foodamount = 80;
let travamount = 500;
export const prodDemoMaps: Product[] = [
  ...[cloth3, product3, food3, travel3, cloth8, product7, travel3, travel5].map(
    (img, index) => ({
      id: index + 1,
      name: img,
      category: "generate",
...
export const ProductMaps = [
  ...
  // Foods
  ...[food1, food2, food3, food4, food5, food6, food7, food8, food9].map(
    (img, index) => ({
      id: index + 19,
      name: img,
      category: "Food",
